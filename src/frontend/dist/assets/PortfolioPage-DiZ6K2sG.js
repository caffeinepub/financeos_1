import { c as createLucideIcon, Q as useParams, U as useNavigate, u as useActor, a as useCurrency, r as reactExports, j as jsxRuntimeExports, z as TrendingUp, B as Button, Z as Zap, E as ChartColumn, V as PiggyBank, x as Trash2, o as Dialog, p as DialogContent, q as DialogHeader, s as DialogTitle, v as Label, I as Input, w as DialogFooter, C as ChevronDown } from "./index-CSLSSYV9.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "./card-BK3u_c6l.js";
...
import { R as ResponsiveContainer, C as Cell, T as Tooltip, a as CartesianGrid, X as XAxis, Y as YAxis, b as Legend, B as Bar, L as LabelList } from "./generateCategoricalChart-DTDaXDHQ.js";
...
function PortfolioPage() {
  ...
  const save = async () => {
    ...
    if (editing) {
      const updatedHolding = { ...editing, ...holdingData };
      setHoldings(
        (prev) => prev.map((h) => h.id === editing.id ? updatedHolding : h)
      );
      setOpen(false);
      try {
        ...
        setHoldings(
          (prev) => prev.map((h) => h.id === editing.id ? editing : h)
        );
        setOpen(true);
      } finally {
        setSaving(false);
      ...
      const newHolding = { id: newId, ...holdingData };
