      ...
      <div className="min-h-screen bg-slate-900 p-6">
        <div className="animate-pulse space-y-4">
          {["s1", "s2", "s3", "s4", "s5", "s6"].map((k) => (
            <div key={k} className="h-16 bg-slate-800 rounded-2xl" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
          ...
          <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3 items-end">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <Input
                    ...
                    className="bg-slate-700 border-slate-600 text-white h-8 text-xs w-28"
                  />
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  >
                    <SelectTrigger className="bg-slate-700 border-slate-600 text-white h-8 text-xs w-28">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-slate-800 border-slate-700">
                      <SelectItem value="all">All</SelectItem>
                ...
                {tagFilter && (
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 bg-slate-700 rounded-lg text-xs text-amber-400 hover:bg-slate-600"
                  >
            ...
            {logFiltered.length === 0 ? (
              <div
                ...
                className="bg-slate-800 rounded-2xl border border-slate-700 p-12 flex flex-col items-center gap-3 text-center"
              >
                                ...
                                {t.tags
                                  ...
                                  .map((tag) => (
                                    <button
                                      ...
                                      className="text-xs px-1.5 py-0.5 rounded-full bg-slate-700 text-slate-300 hover:bg-slate-600"
                                    >
                                      {tag.trim()}
                                    </button>
                                  ))}
                ...
                <div className="space-y-2">
                  {checklist.map((item) => (
                    ...
                    >
                      ...
                      />
                      <span
                        className={`flex-1 text-sm ${item.isChecked ? "line-through text-slate-500" : "text-slate-300"}`}
                      >
                        {item.text}
                      </span>
                      <button
                          ...
                          >
                            ...
                            {expanded && (
                              <div className="mt-3 space-y-2">
                                ...
                                {t.notes && (
                                  <div className="text-xs text-slate-300 bg-slate-800 rounded-lg p-2">
                                    {t.notes}
                                  </div>
                                )}
                                {lesson && (
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Best Time Period */}
                <div className="bg-slate-800 rounded-2xl border border-slate-700 p-4 md:col-span-2">
                  ...
                  <TableBody>
                    {dayStats.map((d) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <span
                            className={`text-sm font-semibold ${d.trades === 0 ? "text-slate-600" : d.winRate >= 50 ? "text-emerald-400" : "text-red-400"}`}
                          >
      ...
      <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
        <DialogContent
          className="bg-slate-900 border-slate-700 text-white max-w-3xl max-h-[90vh] overflow-y-auto"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-slate-800 border-slate-600 text-white mt-1 disabled:opacity-50"
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <Input
                  placeholder="e.g. Trending, Sideways"
                  value={form.marketConditions}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, marketConditions: e.target.value }))
                  }
                  className="bg-slate-800 border-slate-600 text-white mt-1"
                />
              </div>
            ...
            {formPnL && (
              <div className="bg-slate-800 rounded-xl p-3 border border-slate-700">
                <p className="text-xs text-slate-500 mb-2">Auto-calculated</p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div>
  ...
  return (
    <div>
      <div className="grid grid-cols-7 gap-1 mb-1">
        {dayLabels.map((d) => (
          <div key={d} className="text-center text-xs text-slate-500">
            {d}
          </div>
        ))}
      </div>
            ...
            return (
              <div
                ...
                className={`h-8 rounded flex items-center justify-center text-xs font-medium cursor-default ${bg} ${
                  pnl !== null ? "text-white" : "text-slate-500"
                }`}
              >
                {day}
              </div>
      ...
      <div className="flex items-center gap-2 mt-3 text-xs text-slate-500">
        ...
        <div className="w-3 h-3 rounded bg-slate-700" /> No trades
