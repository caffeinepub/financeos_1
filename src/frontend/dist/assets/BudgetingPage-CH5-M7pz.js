import { c as createLucideIcon, u as useActor, a as useCurrency, r as reactExports, j as jsxRuntimeExports, z as TrendingUp, B as Button, I as Input, o as Dialog, p as DialogContent, q as DialogHeader, s as DialogTitle, v as Label, w as DialogFooter, x as Trash2, V as PiggyBank, X as BookOpen } from "./index-CSLSSYV9.js";
...
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-BK3u_c6l.js";
import { T as Table, b as TableHeader, c as TableRow, d as TableHead, a as TableBody, e as TableCell } from "./table-_x62dJN5.js";
import { B as Budget5030Chart } from "./Budget5030Chart-DJID3gcp.js";
import { P as PieChart, a as Pie } from "./PieChart-qNLKoBvA.js";
import { C as Cell, R as ResponsiveContainer, a as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, b as Legend, B as Bar, L as LabelList } from "./generateCategoricalChart-DTDaXDHQ.js";
...
function BudgetingPage() {
  ...
  const onAddTransaction = (tx) => {
    setTransactions(
      (prev) => [tx, ...prev].sort((a, b) => b.date.localeCompare(a.date))
    );
  };
  const onUpdateTransaction = (tx) => {
  ...
  const handleAutofill = () => {
    ...
    const savingsAmt = expenses.filter((t) => (catTypeMap[t.categoryId] ?? "Needs") === "Savings").reduce((s, t) => s + t.amount, 0);
  ...
  const totalExpense = reactExports.useMemo(
    () => categories.filter((c) => c.categoryType === TransactionType.Expense).reduce((s, c) => s + c.monthlyLimit, 0),
    [categories]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "budgeting.page", className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "expenses", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "expenses", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExpensesTab,
        {
          categories,
          transactions,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "tracker", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        MonthlyTrackerTab,
        {
          categories,
          transactions,
