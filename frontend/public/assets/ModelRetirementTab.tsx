...
import { PiggyBank, Shield, TrendingUp, Info } from 'lucide-react';
...
const allocationModels: Record<RiskProfile, AllocationModel> = {
    conservative: {
...
export function ModelRetirementTab() {
    ...
    const calculateProjection = () => {
        ...
        const lumpsumFV = capital * Math.pow(1 + monthlyRate, months);
    ...
    const projectionData = Array.from({ length: Math.min(years, 25) }, (_, i) => {
        ...
        return {
            year: `Year ${year}`,
            corpus: Math.round(lumpsumFV + sipFV),
        };
    });
    ...
    return (
        <div className="space-y-6 p-6 animate-slide-up">
            <div className="grid gap-6 lg:grid-cols-2">
                <Card className="shadow-premium border-border/50">
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-3">
                            ...
                            <Select value={selectedProfile} onValueChange={(value) => setSelectedProfile(value as RiskProfile)}>
                        ...
                        <Alert>
                            <AlertDescription className="text-sm">
                                ...
                                <p className="mt-2 text-xs">Expected Annual Return: <strong>{model.expectedReturn}%</strong></p>
                            </AlertDescription>
                        </Alert>
                        ...
                        <Card className="bg-success/5 border-success/20">
                            <CardContent className="pt-6">
                                <div className="text-center">
                                    <p className="text-sm text-muted-foreground mb-1">Projected Retirement Corpus</p>
                ...
                <Card className="shadow-premium border-border/50">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <h4 className="font-semibold text-sm mb-3">Allocation Breakdown</h4>
                            {allocationAmounts.map((item, index) => (
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <Card className="shadow-premium border-border/50 bg-primary/5">
                    <CardContent className="pt-6">
                ...
                <Card className="shadow-premium border-border/50 bg-success/5">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-3">
                ...
                <Card className="shadow-premium border-border/50 bg-warning/5">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-3">
                            <PiggyBank className="h-5 w-5 text-warning mt-0.5" />
                            <div>
            ...
            <Alert>
                <AlertDescription className="text-sm">
                    <strong>Disclaimer:</strong> This is a suggested model portfolio for retirement planning based on industry standards. 
                    Actual returns may vary based on market conditions. Please consult with a certified financial advisor before making investment decisions. 
