import { c as createLucideIcon, a as useCurrency, r as reactExports, j as jsxRuntimeExports, B as Button, Y as Sparkles, _ as Send, z as TrendingUp, v as Label, I as Input, $ as Shield, A as ChartPie, E as ChartColumn, C as ChevronDown, V as PiggyBank, a0 as useIsMobile, u as useActor } from "./index-CnGSD72i.js";
import { B as Badge } from "./badge-D07Gz56W.js";
import { C as Card, b as CardHeader, c as CardTitle, d as CardDescription, a as CardContent } from "./card-CGQo_Mvk.js";
...
import { C as ChevronLeft, a as CircleCheck } from "./circle-check-DKBQ94vT.js";
import { C as CircleAlert } from "./circle-alert-CRWd7tLj.js";
import { T as TrendingDown } from "./trending-down-j0uEySS7.js";
import { R as ResponsiveContainer, C as Cell, T as Tooltip, a as CartesianGrid, X as XAxis, Y as YAxis, b as Legend } from "./generateCategoricalChart-BW3OlwYa.js";
import { P as PieChart, a as Pie } from "./PieChart-BOWrVKaq.js";
import { L as LineChart, a as Line } from "./LineChart-CV3cD-jn.js";
import { M as ModelDebtTab } from "./ModelDebtTab-CjCzTshy.js";
import { I as Info, M as ModelGoalPlanningTab } from "./ModelGoalPlanningTab-YGqVsgTT.js";
import { H as Heart, F as FIRECalculator, T as ThreeBucketCalculator, a as TwoBucketCalculator, R as RetirementReadinessCalculator } from "./TwoBucketCalculator-AnWAt-BV.js";
import { T as TriangleAlert } from "./triangle-alert-CoJRZoxt.js";
import { A as Alert, a as AlertDescription } from "./alert-Ce_-qASF.js";
import { S as Search } from "./search-Cskbhp4H.js";
import "./index-1FLTVpeQ.js";
import "./index-cXpx_5cg.js";
import "./index-BKbU52fm.js";
import "./plus-BWUB0HmM.js";
import "./index-CPHcXKB0.js";
import "./table-CpMNwfcq.js";
import "./progress-DrS53CQh.js";
/**
...
function FourBucketCalculator() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl shadow-sm border border-slate-100", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: BUCKETS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs", children: [
            "B",
            b.key.slice(1),
            " Return (% p.a.)"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: rates[b.key],
              onChange: (e) => setRates((prev) => ({ ...prev, [b.key]: e.target.value })),
              type: "number",
              min: "0",
              max: "30",
              step: "0.5",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl shadow-sm border border-slate-100 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-950/30 dark:to-cyan-950/30 border-teal-200 dark:border-teal-800", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base", children: "4-Bucket Allocation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: [
          "Total corpus: ",
          formatCurrency(totalCorpus),
          " — split across 4 buckets by time horizon"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-3", children: result.map((b, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm font-semibold ${b.text}`, children: b.label }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-bold ${b.text} text-sm`, children: formatCurrency(b.amount) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: b.pctLabel })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-1.5 bg-white/60 rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between mt-1.5 text-xs text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { title: b.tip, children: [
              "💡 ",
              b.tip
            ] }) }),
            b.annualIncome > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-xs mt-1 ${b.text} font-medium`, children: [
              "Annual income: ",
              formatCurrency(b.annualIncome),
              " · Sustains ~",
              b.years > 50 ? "50+" : b.years.toFixed(1),
              " years"
            ] })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl shadow-sm border border-slate-100", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-1 overflow-x-auto pb-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Bucket 4 (growth) feeds Bucket 3 every 5–10 years → Bucket 3 feeds Bucket 2 every 3–5 years → Bucket 2 refills Bucket 1 every 1–2 years → Bucket 1 covers monthly expenses." })
      ] })
    ] })
  ] });
}
...
function ModelRetirementTab() {
  ...
  const subCards = [
    ...
    },
    {
      ...
      content: /* @__PURE__ */ jsxRuntimeExports.jsx(FourBucketCalculator, {})
    },
    {
      id: "threebucket",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: subCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-slate-800 dark:text-slate-100", children: card.title }),
                "badge" in card && card.badge && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        open === card.id && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 border-t border-slate-50 dark:border-slate-800", children: card.content })
      ]
    },
    card.id
  )) });
